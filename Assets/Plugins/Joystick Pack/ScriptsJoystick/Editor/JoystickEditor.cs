...
{
    private SerializedProperty _controlPath;
    ...
    {
        _controlPath = serializedObject.FindProperty("_controlPath");
    ...
    {
        EditorGUILayout.PropertyField(_controlPath, new GUIContent("Control Path", "Path to the InputAction controls"));
